...
public class Player implements PlayerInterface {
	...
	public Card getCardToPlay() {
		Card front = cardsToPlay.removeFront();
		return front;
		
//		// if cardToPlay and cardWon is empty, null
//		if(cardsToPlay.isEmpty()){
//			if(cardsWon.isEmpty()){
//				return null;
//			} else {
//				String cardsToPlayName = cardsToPlay.getName();
//				String cardsWonName = cardsWon.getName();
//				cardsToPlay = cardsWon;
//				cardsToPlay.setName(cardsToPlayname)l
//				cardsToPlay.shuffle();
//				cardsWon = new CompletedDcek(cardsWonNAme);
//				
//				System.out.println(name + " restarting with " + cardsToPlay.size());
//			}
//		}
//		return true;
//		
...
//		war.addToBack(playedCard);
//		for(int i = 0; i<3; i++){
//			Card card = getCardToPlay();
//			if(card == null)
//				return false;
//			else
//				war.addToBack(card);
