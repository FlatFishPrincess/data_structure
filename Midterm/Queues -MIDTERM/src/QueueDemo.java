...
//		QueueInterface<String> myQueue = new CompletedLinkedQueue<>();
//		QueueInterface<String> myQueue = new CompletedArrayQueue<>();
		...
		try {
			...
			System.out.println("Oops exception thrown from an empty queue: " + e);
		}
