...
// ========================================================================================
	 ...
	 */
	public static <T extends Comparable<T>> boolean inSortedArrayRecursive(T[] anArray, T anEntry) {
	...
	// first >= 0 and < anArray.length.
	// last >= 0 and < anArray.length.
	private static <T extends Comparable<T>> boolean binarySearch(T[] anArray, int first, int last,
			T desiredItem) {
		boolean found;
