 ...
 * @version 5.0
 */
public class BinarySearchTreeIterative<T extends Comparable<? super T>> extends CompletedBinaryTree<T>
	...
	private T addEntry(T anEntry) {
		...
		while (!found) {
			...
			if (comparison == 0) { // anEntry matches currentEntry;
...
/*
   // SOLUTION to Exercise 12, Chapter 26
