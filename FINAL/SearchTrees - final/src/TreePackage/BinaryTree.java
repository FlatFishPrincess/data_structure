...
//	private void initilizeTree(T rootData, BinaryTree<T> leftTree, BinaryTree<T> rightTree) {
//		BinaryNode<T> newNode = new BinaryNode<>(rootData);
//		newNode.setLeftChild(leftTree.getRootNode());
//		newNode.setRightChild(rightTree.getRootNode());
//	}
	/**
...
//			return rootNode.getData();
	...
	private class PostOrderIterator<T> implements Iterator<T>{
		 ...
		 public T next(){
			 BinaryNode<T> nextNode, leftNode = null;
			 ...
			 if(parent.getLeftChild().equals(nextNode))
	...
	private class LevelOrderIterator<T> implements Iterator<T>{
		 ...
		 public T next(){
			 ...
			 if(nextNode.hasLeftChild())
				 queue.enqueue(nextNode.getLeftChild());
			 if(nextNode.hasRightChild())
				 queue.enqueue(nextNode.getRightChild());
			 return nextNode.getData();
