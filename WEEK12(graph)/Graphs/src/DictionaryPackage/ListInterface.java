...
public interface ListInterface<T> {
	 ...
	 *                      be removed.
	 * @return A reference to the removed entry or null if newPosition is outside of
	 * 			the range of newPosition < 0 or newPosition > size() - 1
	 */
	 ...
	 *                      givenPosition.
	 * @return A reference to the original entry that was replaced or null if givenPosition is
	 * 						outside of the range where 0 <= givenPosition < size()
	 */
	 ...
	 * @return A reference to the original entry that was replaced or null if 
