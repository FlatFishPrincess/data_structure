...
/**
 * A driver that demonstrates the class DirectedGraph and a weighted graph.
 * 
 * @author Frank M. Carrano
 * @version 5.0
 */
public class CheapestPathBFSandDFSDemo {
	...
	public static void main(String[] args) {
		System.out.println("Testing the directed, weighted graph in Figure 29-18a.");
		setGraphFig29_18a();
		...
		System.out.println("\nFinding the cheapest path in the graph in Figure 29-18a:\n");
		testCheapestPath();
	...
	public static void setVerticesFig29_18a() {
		myGraph.clear();
	...
	public static void setEdgesFig29_18a() {
...
/*
 Testing the directed, weighted graph in Figure 29-18a.
