...
/**
 * A driver that demonstrates the class UndirectedGraph and a weighted graph.
 * 
 * @author Frank M. Carrano
 * @author Timothy M. Henry
 * @version 5.0
 */
public class GraphUndirectedWeightedDemo
{
	...
	public static void main(String[] args) {
		System.out.println(
				"Testing a weighted graph like the one in Figure 29-18a, " + "but without directions on its edges:");
		setGraphFig29_18a();
		...
		System.out.println("\n\nTesting Example 29.29 using the graph in Figure 29-3:\n");
		testExample29_29();

		System.out.println("Done.");
	} // end main

	public static void setGraphFig29_18a() {
		setVerticesFig29_18a(); // Graph cleared before setting vertices
		setEdgesFig29_18aUndirected();
	} // end setGraphFig29_18a
	...
	public static void testEdgesFig29_18a() {
	...
	private static void showPath(String vertex1, String vertex2, String expectedPath, int expectedCost) {
		...
		System.out.println(
				"Expected path:                   " + expectedPath + " " + "                  " + expectedCost);
	} // end showPath

	private static void setVerticesFig29_18a() {
		myGraph.clear();
		...
		myGraph.addVertex(H);
		myGraph.addVertex(I);
	} // end setVerticesFig29_18a

	private static void setEdgesFig29_18aUndirected() {
   ...
   } // end setEdgesFig29_18aUndirected

	public static void testExample29_29() {
