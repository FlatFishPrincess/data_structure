...
/**
 * A driver that demonstrates the class UndirectedGraph and an unweighted graph.
 * 
 * @author Frank M. Carrano
 * @author Timothy M. Henry
 * @version 5.0
 */
public class GraphUndirectedUnweightedDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\nTesting Example 29.26 to create the graph in Figure 29-21:\n");
		testExample29_26();
	...
	public static void testExample29_26() {
		...
		System.out.println("Number of vertices = " + airMap.getNumberOfVertices() + " (should be 3)");
		System.out.println("Number of edges = " + airMap.getNumberOfEdges() + " (should be 2)");
...
/*
 Testing an undirected, unweighted graph like the one in Figure 29-10, but without directions on its edges.
