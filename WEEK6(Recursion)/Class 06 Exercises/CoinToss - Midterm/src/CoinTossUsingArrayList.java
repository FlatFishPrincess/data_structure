 ...
 *
 */
public class CoinTossUsingArrayList {

	public static void main(String[] args) {

		// replace the below with an AList or an LList
		
		ListInterface<Coin> coins = new ArrayListUsingListInterface<>();
		ListInterface<Coin> headsCoins = new ArrayListUsingListInterface<>();
