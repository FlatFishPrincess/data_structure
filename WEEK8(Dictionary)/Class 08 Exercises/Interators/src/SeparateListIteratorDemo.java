...
/**
 * A driver that demonstrates the class SeparateListIterator with an instance of
 * LList or AList.
 * 
 ...
 * @version 5.0
 */
public class SeparateListIteratorDemo {
	public static void main(String[] args) {
		
		// Change to AList or any other to test
		
		testIteratorOperations(new AList<>());
		testExamples(new AList<>());
		System.out.println("\n\nDone.");
	} // end main

	public static void testIteratorOperations(ListInterface<String> myList) {
	...
	public static void testExamples(ListInterface<String> nameList) {
