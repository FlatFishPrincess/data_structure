 ...
 */
public class LinkedListWithListIterator<T extends Comparable<? super T>> implements ListWithIteratorInterface<T>{
	private Node<T> firstNode; // Reference to first node of chain
	private int numberOfEntries;

	public LinkedListWithListIterator() {
	...
	public ListIterator<T> getIterator() {
		// TODO Auto-generated method stub
		return new ListIteratorForLists<>(this);
	}
